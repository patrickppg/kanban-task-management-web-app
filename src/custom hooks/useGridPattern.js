    ...
    function handleKeyDown(e) {
      ...
      switch (e.code) {
        case "Enter": {
          ...
          e.preventDefault()
          e.target.querySelector("input[name='column']").focus()
          break
        }
